...
#include "RoseEngineC/Shader.h"
#include "RoseEngineC/Camera.h"
...
int main() {
    ...
    RoseEngineC::FileSystem::saveCurrentPath();
    RoseEngineC::FileSystem::setWorkingDirectory("../assets");
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "RoseEngine", NULL, NULL);
    if (window == NULL)
    {
